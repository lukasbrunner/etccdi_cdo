...
if [ "$mm" == "m" ]; then
    ...
    cdo chname,$tasmin,$index -setunit,"1" -monmean -gtc,0 -sub ${outfile}_365day.nc $infile2 ${outfile}.nc || { echo "ERROR"; exit 1; }
else
    cdo chname,$tasmin,$index -setunit,"1" -yearmean -gtc,0 -sub ${outfile}_365day.nc $infile2 ${outfile}.nc || { echo "ERROR"; exit 1; }    
fi
