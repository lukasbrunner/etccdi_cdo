...
unlink settings.sh
ln -s settings_IFS-c4.sh settings.sh

# --- zoom 9 ---
# fn_tasmax=/work/bm1235/b381815/hazard_hackathon/IFS-9-FESOM-5-production/IFS-9-FESOM-5-production_tasmax_z9_day_2021-2049.nc
# fn_tasmin=/work/bm1235/b381815/hazard_hackathon/IFS-9-FESOM-5-production/IFS-9-FESOM-5-production_tasmin_z9_day_2021-2049.nc
# fn_tas=none
# fn_pr=/work/bm1235/b381815/hazard_hackathon/IFS-9-FESOM-5-production/IFS-9-FESOM-5-production_pr_z9_day_2021-2049.nc
# fn_mask=none
# savepath=/work/bm1235/b381815/hazard_hackathon/IFS-9-FESOM-5-production/ETCCDI/z9/
# ow=

# --- zoom 6 ---
path=/work/uc1275/LukasBrunner/data/SubGridVariability
fn_tasmax=$path/input/IFS-9-FESOM-5-production_tasmax_z6_day_2021-2049.nc
fn_tasmin=$path/input/IFS-9-FESOM-5-production_tasmin_z6_day_2021-2049.nc
fn_tas=none
fn_pr=$path/input/IFS-9-FESOM-5-production_pr_z6_day_2021-2049.nc
fn_mask=none
savepath=$path/processed/ETCCDI
ow=
