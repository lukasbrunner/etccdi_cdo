...
fn_tasmax=$path/input/ICON-ngc4008_tasmax_z9_day_2020-2049.nc
fn_tasmin=$path/input/ICON-ngc4008_tasmin_z9_day_2020-2049.nc
fn_tas=$path/input/ICON-ngc4008_tas_z9_day_2020-2049.nc
fn_pr=none # $path/input/ICON-ngc4008_pr_z9_day_2020-2049.nc
fn_mask=none
...
# --- zoom 6 ---
# path=/work/uc1275/LukasBrunner/data/SubGridVariability/
# fn_tasmax=$path/input/ICON-ngc4008_tasmax_z6_day_2020-2049.nc
# fn_tasmin=$path/input/ICON-ngc4008_tasmin_z6_day_2020-2049.nc
# fn_tas=$path/input/ICON-ngc4008_tas_z6_day_2020-2049.nc
# fn_pr=none # $path/input/ICON-ngc4008_pr_z6_day_2020-2049.nc
# fn_mask=none
# savepath=$path/processed/ETCCDI
# ow=
